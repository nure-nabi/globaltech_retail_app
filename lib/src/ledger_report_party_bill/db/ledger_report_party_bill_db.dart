...
class LedgerReportDatabase {
  ...
  Future<List<LedgerReportModel>> getDateWiseList({
    ...
    if(fromDate.isNotEmpty) {
      myQuery = '''SELECT * FROM ${DatabaseDetails.ledgerDetailTable}
        where
    ...
    String s =
        ''' SELECT * FROM ${DatabaseDetails.ledgerDetailTable}  WHERE ${DatabaseDetails.date} BETWEEN "$fromDate" AND "$toDate" ''';
