...
class PDCPdfInvoiceApi {
  static Future<File> generate({
              ...
              child: Column(
                children: [
                  ...
                  dataValue(
                    title: "In Words",
                    value:
                    "${NumberToWordsEnglish.convert(double.parse(receivedAmount).toInt()).toFirstLetterCapital()} only.",
                  ),
    ...
    return FileHandleApi.saveDocument(name: 'pdc_report.pdf', pdf: pdf);
  }
}
