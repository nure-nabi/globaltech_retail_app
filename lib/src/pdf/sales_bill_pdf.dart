...
class PdfInvoiceApiSales{
  static Future<File> generate({
    ...
    required List<SalesBillReportDataModel> dataList,
          ...
          return [
            ...
            TableHelper.fromTextArray(
                ...
                headerStyle: TextStyle(
                  fontWeight: FontWeight.bold // Center the header text
                ),
    ...
    return FileHandleApiSales.saveDocument(name: 'my_invoice.pdf', pdf: pdf);
  }
}
