...
import 'package:retail_app/src/purchase/model/purchase_order_model.dart';
...
class FileHandleApiPurchaseProduct {
...
class PdfInvoiceProductPurchase {
  static Future<File> generate({
    ...
    required List<PurchaseProductOrderModel> productList,
  }) async {
    final pdf = Document();
    ...
    if(productList[0].bSign1 == "-"){
      bTermDis1 = bTermDisc1;
    }else if(productList[0].bSign1 == "+"){
      bTermVate2 = bTermDisc1;
    }
    if(productList[0].bSign2 == "-"){
      bTermDis1 = bTermVat2;
    }else if(productList[0].bSign2 == "+"){
      bTermVate2 = bTermVat2;
    }
    if(productList[0].bSign3 == "-"){
      bTermDis1 = bTermDisc1;
    }else if(productList[0].bSign3 == "+"){
      bTermVate2 = bTermVat2;
    }
      ...
      MultiPage(
        ...
        build: (context) {
          ...
          return [
            ...
            Divider(),
            Center(
                child: Text("Purchase Invoice",style: TextStyle(color: PdfColors.orangeAccent,fontWeight: FontWeight.bold))
            ),
            Divider(),
                  ...
                  productList.length,
                    ...
                    List<String> rowData = List<String>.generate(
                      updatedTableHeaders.length,
                          (col) => productList[row].getIndex(col,pTermDic.toString(),pTermVat.toString()),
                    );
    ...
    return FileHandleApiPurchaseProduct.saveDocument(
