class SalesBillReportModel {
  ...
  final List<SalesBillReportDataModel> data;

  factory SalesBillReportModel.fromJson(Map<String, dynamic> json) {
    return SalesBillReportModel(
      message: json["MESSAGE"] ?? "",
      statusCode: json["STATUS_CODE"] ?? 0,
      data: json["data"] == null
          ? []
          : List<SalesBillReportDataModel>.from(
          json["data"].map((x) => SalesBillReportDataModel.fromJson(x))),
    );
  }
...
class SalesBillReportDataModel {
  SalesBillReportDataModel({
    required this.hvno,
    required this.hDate,
    required this.hMiti,
 ...
 // final String voucherNumber;
  ...
  factory SalesBillReportDataModel.fromJson(Map<String, dynamic> json) {
    return SalesBillReportDataModel(
      hvno: json["HVno"] ?? "",
      hDate: json["HDate"] ?? "",
      hMiti: json["HMiti"] ?? "",
